...
let products = [
  ...
  {
    id: nanoid(6),
    title: "Набор кухонных ножей SteelPro",
  ...
  {
    id: nanoid(6),
    title: "Аромадиффузор Forest Breeze",
    category: "Декор",
  ...
  {
    id: nanoid(6),
    title: "Органайзер для белья FoldBox",
    category: "Хранение",
  ...
  {
    id: nanoid(6),
    title: "Набор тарелок CeramicArt",
    category: "Кухонные товары",
  ...
  {
    id: nanoid(6),
    title: "Настенный декор LeafLine",
    category: "Декор",
  ...
  {
    id: nanoid(6),
    title: "Корзина для хранения LinenBox",
    category: "Хранение",
  ...
  {
    id: nanoid(6),
    title: "Светодиодная гирлянда WarmLine",
    category: "Освещение",
...
app.delete("/api/products/:id", (req, res) => {
  const id = req.params.id; // строка nanoid
